// PDF BUILDER — Atelier A2: möchte / würde gern / hätte gern (Cele 3 feluri de AȘ VREA)
(function () {
    ...
    function buildCast() {
        return `<div class="cast-banner">
            ...
            <div class="cast-grid">
                <div class="cast-card"><img src="images/andreea.png" alt="Andreea"><div class="name">Andreea 🇷🇴</div><div class="detail">Comandă la cafenea</div></div>
                <div class="cast-card"><img src="images/carolina.png" alt="Carolina"><div class="name">Carolina</div><div class="detail">Visează cu glas tare</div></div>
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Cele 3 feluri de AȘ VREA (möchte / würde gern / hätte gern)</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += fillPromptBlock('Übung 1 — Forma conjugată', 'möchte/möchtest/möchte/möchten/möchtet/möchten · würde/würdest… · hätte/hättest…', ex1Data);
        }
        if (typeof ex2Data !== 'undefined') {
            html += choiceBlock('Übung 2 — würde gern sau hätte gern?', 'Obiect (substantiv) → hätte gern · acțiune (verb la infinitiv) → würde gern.', ex2Data);
        }
        if (typeof ex3Data !== 'undefined') {
            html += fillPromptBlock('Übung 3 — möchte conjugat', 'Forma politicoasă a lui wollen: ich möchte · du möchtest · er möchte · wir/sie/Sie möchten · ihr möchtet.', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += choiceBlock('Übung 4 — Politicos & corect', 'Obiect → hätte gern/möchte · acțiune → würde gern/möchte · niciodată „ich will" la politețe.', ex4Data);
        }
        if (typeof ex5Data !== 'undefined') {
            html += translateBlock('Übung 5 — Traducere RO → DE', 'obiect → hätte gern/möchte + Nomen · acțiune → würde gern/möchte + Infinitiv.', ex5Data);
        }
        return html;
    }
    ...
    function buildVerbs() {
        let html = `<h1 class="chapter new-section">🔁 4. Verbe pentru „a vrea" & cafenea — Präsens · Präteritum · Perfekt</h1>
            <div class="andreea-note">
                <div class="andreea-note-content">
                    <div class="speaker">📌 Andreea îți spune:</div>
                    <div>möchte vine din mögen (Konjunktiv II) și e forma politicoasă a lui wollen. hätte gern vine din haben, würde gern din werden. Plus bestellen (a comanda) și bezahlen (a plăti) — verbe de cafenea.</div>
                </div>
            </div>`;
        if (typeof verbsData !== 'undefined') {
            verbsData.forEach((v, idx) => {
                ...
                else if (v.typ && v.typ.indexOf('modal') === 0) { badgeClass = 'strong'; badgeLabel = 'MODAL'; }
